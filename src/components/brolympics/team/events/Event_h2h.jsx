...
const Matchup = ({
  ...
  switch (true) {
    case team_1.uuid === winner?.uuid && team_1.uuid === team:
      team_1_text = "text-tertiary font-semibold";
      break;
    case team_2.uuid === winner?.uuid && team_1.uuid === team:
      team_1_text = "text-red";
      break;
    default:
      team_1_text = "";
  }
  ...
  switch (true) {
    case team_2.uuid === winner?.uuid && team_2.uuid === team:
      team_2_text = "text-tertiary font-semibold";
      break;
    case team_1.uuid === winner?.uuid && team_2.uuid === team:
      team_2_text = "text-red";
      break;
    default:
      team_2_text = "";
  }
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-full">
        ...
        <div
          className={` ${team_2_text} w-2/5 text-end`}
    ...
    <div className="flex justify-between">
      <div className="w-1/2">
        ...
        <div className="grid grid-cols-2">
          <div>PF</div>
          <div>{score_for} pts</div>
          <div>PA</div>
          <div>{score_against} pts</div>
        </div>
      </div>
      <div className="w-1/2">
