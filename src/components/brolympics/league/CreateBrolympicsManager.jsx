...
import { fetchCreateBrolympics } from "../../../api/fetchBrolympics"
...
const CreateBrolympicsManager = () => {
  ...
  const createBrolympics = async () => {
    const response = await fetchCreateBrolympics(uuid, brolympics, h2hEvents, indEvents, teamEvents)
    ...
    if (response.ok){
      ...
      showNotification("There was an while trying to create your Brolymipcs. Please check back shortly.") 
    }
  }
