        ...
        <h2 className="py-2">Scoring Settings</h2>
            ...
            <div className="flex items-center justify-between min-h-[50px]">
                <div>
                    ...
                    <p className="text-[10px]">Is this event won by the higher score or the lower score. <br/> Currently set to: <span className="font-bold">{formValues.is_high_score_wins ? 'High Score Wins' : 'Low Score Wins'}</span></p>
                </div>
                <button
